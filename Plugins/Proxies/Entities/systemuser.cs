...
namespace Proxy 
{
	...
	public partial class SystemUser : CCLLC.CDS.Sdk.EarlyBound.EntityProxy
	{
		...
		public enum eSystemManagedUserType { EntraUser=0,  C2User=1, }
		...
		public virtual bool? IsAllowedByIpFirewall
		{
			get => GetPropertyValue<bool?>("isallowedbyipfirewall"); 
			set => SetPropertyValue("isallowedbyipfirewall", value); 
		}

		[AttributeLogicalName("isallowedbyipfirewallname")]
		public virtual string IsallowedbyipfirewallName
		{
			get => GetPropertyValue<string>("isallowedbyipfirewallname"); 
		}
		...
		public virtual eSystemManagedUserType? SystemManagedUserType
		{
			get => (eSystemManagedUserType?)GetPropertyValue<OptionSetValue>("systemmanagedusertype")?.Value;
			set => SetPropertyValue("systemmanagedusertype", value is null ? null : new OptionSetValue((int)value)); 
		}

		[AttributeLogicalName("systemmanagedusertypename")]
		public virtual string SystemmanagedusertypeName
		{
			get => GetPropertyValue<string>("systemmanagedusertypename"); 
		}
