...
namespace Proxy 
{
	[EntityLogicalName("sf_repository")]
	public partial class SfRepository : CCLLC.CDS.Sdk.EarlyBound.EntityProxy
	{
		public const string EntityLogicalName = "sf_repository";
		...
		public class Fields
		{			
			public const string Id = "sf_repositoryid";
			...
			public const string SfRepositoryId = "sf_repositoryid";
		...
		[AttributeLogicalName("sf_repositoryid")]
		public override Guid Id
		{
			get => base.Id; 
			set 
			{
				SfRepositoryId = value;
				base.Id = value;
			}
		}
		...
		[AttributeLogicalName("sf_repositoryid")]
		public virtual Guid SfRepositoryId
		{
			get => GetPropertyValue<Guid>("sf_repositoryid"); 
			set => SetPropertyValue("sf_repositoryid", value); 
		}
