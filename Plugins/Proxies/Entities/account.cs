...
namespace Proxy 
{
	...
	public partial class Account : CCLLC.CDS.Sdk.EarlyBound.EntityProxy
	{
		...
		{			
			...
			public const string ArpAccountType = "arp_accounttype";
			public const string ArpAccounttypeName = "arp_accounttypename";
			public const string ArpLogo = "arp_logo";
			public const string ArpLogoId = "arp_logoid";
			public const string ArpLogoTimestamp = "arp_logo_timestamp";
			public const string ArpLogoURL = "arp_logo_url";
			public const string ArpNumberOfActiveUsers = "arp_numberofactiveusers";
			public const string ArpNumberOfActiveUsersDate = "arp_numberofactiveusers_date";
			public const string ArpNumberOfActiveUsersState = "arp_numberofactiveusers_state";
		...
		[AttributeLogicalName("arp_accounttype")]
		public virtual GlobalEnums.eArpAccounttype? ArpAccountType
		{
			get => (GlobalEnums.eArpAccounttype?)GetPropertyValue<OptionSetValue>("arp_accounttype")?.Value;
			set => SetPropertyValue("arp_accounttype", value is null ? null : new OptionSetValue((int)value)); 
		}

		[AttributeLogicalName("arp_accounttypename")]
		public virtual string ArpAccounttypeName
		{
			get => GetPropertyValue<string>("arp_accounttypename"); 
		}

		[AttributeLogicalName("arp_logo")]
		public virtual string ArpLogo
		{
			get => GetPropertyValue<string>("arp_logo"); 
			set => SetPropertyValue("arp_logo", value); 
		}

		[AttributeLogicalName("arp_logoid")]
		public virtual Guid ArpLogoId
		{
			get => GetPropertyValue<Guid>("arp_logoid"); 
		}

		[AttributeLogicalName("arp_logo_timestamp")]
		public virtual int? ArpLogoTimestamp
		{
			get => GetPropertyValue<int?>("arp_logo_timestamp"); 
		}

		[AttributeLogicalName("arp_logo_url")]
		public virtual string ArpLogoURL
		{
			get => GetPropertyValue<string>("arp_logo_url"); 
		}

		[AttributeLogicalName("arp_numberofactiveusers")]
		public virtual int? ArpNumberOfActiveUsers
		{
			get => GetPropertyValue<int?>("arp_numberofactiveusers"); 
		}

		[AttributeLogicalName("arp_numberofactiveusers_date")]
		public virtual DateTime? ArpNumberOfActiveUsersDate
		{
			get => GetPropertyValue<DateTime?>("arp_numberofactiveusers_date"); 
		}

		[AttributeLogicalName("arp_numberofactiveusers_state")]
		public virtual int? ArpNumberOfActiveUsersState
		{
			get => GetPropertyValue<int?>("arp_numberofactiveusers_state"); 
		}
