...
namespace Proxy 
{
	[EntityLogicalName("sf_student")]
	public partial class SfStudent : CCLLC.CDS.Sdk.EarlyBound.EntityProxy
	{
		public const string EntityLogicalName = "sf_student";
		...
		public class Fields
		{			
			public const string Id = "sf_studentid";
			...
			public const string SfAge = "sf_age";
			public const string SfName = "sf_name";
			public const string SfStudentId = "sf_studentid";
			public const string SfUniversity = "sf_university";
			public const string SfUniversityName = "sf_universityname";
		...
		[AttributeLogicalName("sf_studentid")]
		...
		[AttributeLogicalName("sf_age")]
		public virtual int? SfAge
		{
			get => GetPropertyValue<int?>("sf_age"); 
			set => SetPropertyValue("sf_age", value); 
		}
		...
		[AttributeLogicalName("sf_studentid")]
		public virtual Guid SfStudentId
		{
			get => GetPropertyValue<Guid>("sf_studentid"); 
			set => SetPropertyValue("sf_studentid", value); 
		}

		[AttributeLogicalName("sf_university")]
		public virtual EntityReference SfUniversity
		{
			get => GetPropertyValue<EntityReference>("sf_university"); 
			set => SetPropertyValue("sf_university", value); 
		}

		[AttributeLogicalName("sf_universityname")]
		public virtual string SfUniversityName
		{
			get => GetPropertyValue<string>("sf_universityname"); 
		}
