...
namespace Proxy 
{
	...
	public partial class Contact : CCLLC.CDS.Sdk.EarlyBound.EntityProxy
	{
		...
		public enum eSfAccessRole { SuperAdmin=1,  Admin=2,  Member=3, }
		...
		{			
			...
			public const string AdxConfirmremovepasswordName = "adx_confirmremovepasswordname";
			...
			public const string AdxIdentityEmailaddress1confirmedName = "adx_identity_emailaddress1confirmedname";
			...
			public const string AdxIdentityLocallogindisabledName = "adx_identity_locallogindisabledname";
			public const string AdxIdentityLockoutenabled = "adx_identity_lockoutenabled";
			public const string AdxIdentityLockoutenabledName = "adx_identity_lockoutenabledname";
			...
			public const string AdxIdentityLogonenabledName = "adx_identity_logonenabledname";
			public const string AdxIdentityMobilephoneconfirmed = "adx_identity_mobilephoneconfirmed";
			public const string AdxIdentityMobilephoneconfirmedName = "adx_identity_mobilephoneconfirmedname";
			...
			public const string AdxIdentityTwofactorenabledName = "adx_identity_twofactorenabledname";
			...
			public const string AdxProfilealertName = "adx_profilealertname";
			public const string AdxProfileIsAnonymous = "adx_profileisanonymous";
			public const string AdxProfileisanonymousName = "adx_profileisanonymousname";
			...
			public const string MsdynDisablewebtrackingName = "msdyn_disablewebtrackingname";
			public const string MsdynIsminor = "msdyn_isminor";
			public const string MsdynIsminorName = "msdyn_isminorname";
			public const string MsdynIsminorwithparentalconsent = "msdyn_isminorwithparentalconsent";
			public const string MsdynIsminorwithparentalconsentName = "msdyn_isminorwithparentalconsentname";
			...
			public const string MsppUserpreferredlcidName = "mspp_userpreferredlcidname";
			...
			public const string SfAccessRole = "sf_accessrole";
			public const string SfAccessroleName = "sf_accessrolename";
			public const string SfIsPasswordSet = "sf_ispasswordset";
			public const string SfIspasswordsetName = "sf_ispasswordsetname";
			public const string SfMemberAirline = "sf_memberairline";
			public const string SfMemberairlineName = "sf_memberairlinename";
			public const string SfParentAirlineId = "sf_parentairlineid";
			public const string SfParentAirlineIdName = "sf_parentairlineidname";
		...
		public virtual bool? AdxConfirmRemovePassword
		{
			get => GetPropertyValue<bool?>("adx_confirmremovepassword"); 
			set => SetPropertyValue("adx_confirmremovepassword", value); 
		}

		[AttributeLogicalName("adx_confirmremovepasswordname")]
		public virtual string AdxConfirmremovepasswordName
		{
			get => GetPropertyValue<string>("adx_confirmremovepasswordname"); 
		}

		[AttributeLogicalName("adx_createdbyipaddress")]
		public virtual string AdxCreatedByIPAddress
		{
			get => GetPropertyValue<string>("adx_createdbyipaddress"); 
			set => SetPropertyValue("adx_createdbyipaddress", value); 
		}

		[AttributeLogicalName("adx_createdbyusername")]
		public virtual string AdxCreatedByUsername
		{
			get => GetPropertyValue<string>("adx_createdbyusername"); 
			set => SetPropertyValue("adx_createdbyusername", value); 
		}

		[AttributeLogicalName("adx_identity_accessfailedcount")]
		public virtual int? AdxIdentityAccessfailedcount
		{
			get => GetPropertyValue<int?>("adx_identity_accessfailedcount"); 
			set => SetPropertyValue("adx_identity_accessfailedcount", value); 
		}

		[AttributeLogicalName("adx_identity_emailaddress1confirmed")]
		public virtual bool? AdxIdentityEmailaddress1confirmed
		{
			get => GetPropertyValue<bool?>("adx_identity_emailaddress1confirmed"); 
			set => SetPropertyValue("adx_identity_emailaddress1confirmed", value); 
		}

		[AttributeLogicalName("adx_identity_emailaddress1confirmedname")]
		public virtual string AdxIdentityEmailaddress1confirmedName
		{
			get => GetPropertyValue<string>("adx_identity_emailaddress1confirmedname"); 
		}

		[AttributeLogicalName("adx_identity_lastsuccessfullogin")]
		public virtual DateTime? AdxIdentityLastsuccessfullogin
		{
			get => GetPropertyValue<DateTime?>("adx_identity_lastsuccessfullogin"); 
			set => SetPropertyValue("adx_identity_lastsuccessfullogin", value); 
		}

		[AttributeLogicalName("adx_identity_locallogindisabled")]
		public virtual bool? AdxIdentityLocallogindisabled
		{
			get => GetPropertyValue<bool?>("adx_identity_locallogindisabled"); 
			set => SetPropertyValue("adx_identity_locallogindisabled", value); 
		}

		[AttributeLogicalName("adx_identity_locallogindisabledname")]
		public virtual string AdxIdentityLocallogindisabledName
		{
			get => GetPropertyValue<string>("adx_identity_locallogindisabledname"); 
		}

		[AttributeLogicalName("adx_identity_lockoutenabled")]
		public virtual bool? AdxIdentityLockoutenabled
		{
			get => GetPropertyValue<bool?>("adx_identity_lockoutenabled"); 
			set => SetPropertyValue("adx_identity_lockoutenabled", value); 
		}

		[AttributeLogicalName("adx_identity_lockoutenabledname")]
		public virtual string AdxIdentityLockoutenabledName
		{
			get => GetPropertyValue<string>("adx_identity_lockoutenabledname"); 
		}

		[AttributeLogicalName("adx_identity_lockoutenddate")]
		public virtual DateTime? AdxIdentityLockoutenddate
		{
			get => GetPropertyValue<DateTime?>("adx_identity_lockoutenddate"); 
			set => SetPropertyValue("adx_identity_lockoutenddate", value); 
		}

		[AttributeLogicalName("adx_identity_logonenabled")]
		public virtual bool? AdxIdentityLogonenabled
		{
			get => GetPropertyValue<bool?>("adx_identity_logonenabled"); 
			set => SetPropertyValue("adx_identity_logonenabled", value); 
		}

		[AttributeLogicalName("adx_identity_logonenabledname")]
		public virtual string AdxIdentityLogonenabledName
		{
			get => GetPropertyValue<string>("adx_identity_logonenabledname"); 
		}

		[AttributeLogicalName("adx_identity_mobilephoneconfirmed")]
		public virtual bool? AdxIdentityMobilephoneconfirmed
		{
			get => GetPropertyValue<bool?>("adx_identity_mobilephoneconfirmed"); 
			set => SetPropertyValue("adx_identity_mobilephoneconfirmed", value); 
		}

		[AttributeLogicalName("adx_identity_mobilephoneconfirmedname")]
		public virtual string AdxIdentityMobilephoneconfirmedName
		{
			get => GetPropertyValue<string>("adx_identity_mobilephoneconfirmedname"); 
		}

		[AttributeLogicalName("adx_identity_newpassword")]
		public virtual string AdxIdentityNewpassword
		{
			get => GetPropertyValue<string>("adx_identity_newpassword"); 
			set => SetPropertyValue("adx_identity_newpassword", value); 
		}

		[AttributeLogicalName("adx_identity_passwordhash")]
		public virtual string AdxIdentityPasswordhash
		{
			get => GetPropertyValue<string>("adx_identity_passwordhash"); 
			set => SetPropertyValue("adx_identity_passwordhash", value); 
		}

		[AttributeLogicalName("adx_identity_securitystamp")]
		public virtual string AdxIdentitySecuritystamp
		{
			get => GetPropertyValue<string>("adx_identity_securitystamp"); 
			set => SetPropertyValue("adx_identity_securitystamp", value); 
		}

		[AttributeLogicalName("adx_identity_twofactorenabled")]
		public virtual bool? AdxIdentityTwofactorenabled
		{
			get => GetPropertyValue<bool?>("adx_identity_twofactorenabled"); 
			set => SetPropertyValue("adx_identity_twofactorenabled", value); 
		}

		[AttributeLogicalName("adx_identity_twofactorenabledname")]
		public virtual string AdxIdentityTwofactorenabledName
		{
			get => GetPropertyValue<string>("adx_identity_twofactorenabledname"); 
		}

		[AttributeLogicalName("adx_identity_username")]
		public virtual string AdxIdentityUsername
		{
			get => GetPropertyValue<string>("adx_identity_username"); 
			set => SetPropertyValue("adx_identity_username", value); 
		}

		[AttributeLogicalName("adx_modifiedbyipaddress")]
		public virtual string AdxModifiedByIPAddress
		{
			get => GetPropertyValue<string>("adx_modifiedbyipaddress"); 
			set => SetPropertyValue("adx_modifiedbyipaddress", value); 
		}

		[AttributeLogicalName("adx_modifiedbyusername")]
		public virtual string AdxModifiedByUsername
		{
			get => GetPropertyValue<string>("adx_modifiedbyusername"); 
			set => SetPropertyValue("adx_modifiedbyusername", value); 
		}

		[AttributeLogicalName("adx_organizationname")]
		public virtual string AdxOrganizationName
		{
			get => GetPropertyValue<string>("adx_organizationname"); 
			set => SetPropertyValue("adx_organizationname", value); 
		}

		[AttributeLogicalName("adx_preferredlcid")]
		public virtual int? AdxPreferredlcid
		{
			get => GetPropertyValue<int?>("adx_preferredlcid"); 
			set => SetPropertyValue("adx_preferredlcid", value); 
		}

		[AttributeLogicalName("adx_profilealert")]
		public virtual bool? AdxProfilealert
		{
			get => GetPropertyValue<bool?>("adx_profilealert"); 
			set => SetPropertyValue("adx_profilealert", value); 
		}

		[AttributeLogicalName("adx_profilealertdate")]
		public virtual DateTime? AdxProfilealertdate
		{
			get => GetPropertyValue<DateTime?>("adx_profilealertdate"); 
			set => SetPropertyValue("adx_profilealertdate", value); 
		}

		[AttributeLogicalName("adx_profilealertinstructions")]
		public virtual string AdxProfilealertinstructions
		{
			get => GetPropertyValue<string>("adx_profilealertinstructions"); 
			set => SetPropertyValue("adx_profilealertinstructions", value); 
		}

		[AttributeLogicalName("adx_profilealertname")]
		public virtual string AdxProfilealertName
		{
			get => GetPropertyValue<string>("adx_profilealertname"); 
		}

		[AttributeLogicalName("adx_profileisanonymous")]
		public virtual bool? AdxProfileIsAnonymous
		{
			get => GetPropertyValue<bool?>("adx_profileisanonymous"); 
			set => SetPropertyValue("adx_profileisanonymous", value); 
		}

		[AttributeLogicalName("adx_profileisanonymousname")]
		public virtual string AdxProfileisanonymousName
		{
			get => GetPropertyValue<string>("adx_profileisanonymousname"); 
		}

		[AttributeLogicalName("adx_profilelastactivity")]
		public virtual DateTime? AdxProfileLastActivity
		{
			get => GetPropertyValue<DateTime?>("adx_profilelastactivity"); 
			set => SetPropertyValue("adx_profilelastactivity", value); 
		}

		[AttributeLogicalName("adx_profilemodifiedon")]
		public virtual DateTime? AdxProfilemodifiedon
		{
			get => GetPropertyValue<DateTime?>("adx_profilemodifiedon"); 
			set => SetPropertyValue("adx_profilemodifiedon", value); 
		}

		[AttributeLogicalName("adx_publicprofilecopy")]
		public virtual string AdxPublicProfileCopy
		{
			get => GetPropertyValue<string>("adx_publicprofilecopy"); 
			set => SetPropertyValue("adx_publicprofilecopy", value); 
		}

		[AttributeLogicalName("adx_timezone")]
		public virtual int? AdxTimeZone
		{
			get => GetPropertyValue<int?>("adx_timezone"); 
			set => SetPropertyValue("adx_timezone", value); 
		}
		...
		public virtual EntityReference MsaManagingpartnerid
		{
			get => GetPropertyValue<EntityReference>("msa_managingpartnerid"); 
			set => SetPropertyValue("msa_managingpartnerid", value); 
		}

		[AttributeLogicalName("msa_managingpartneridname")]
		public virtual string MsaManagingpartneridName
		{
			get => GetPropertyValue<string>("msa_managingpartneridname"); 
		}

		[AttributeLogicalName("msa_managingpartneridyominame")]
		public virtual string MsaManagingpartneridYomiName
		{
			get => GetPropertyValue<string>("msa_managingpartneridyominame"); 
		}

		[AttributeLogicalName("msdyn_disablewebtracking")]
		public virtual bool? MsdynDisablewebtracking
		{
			get => GetPropertyValue<bool?>("msdyn_disablewebtracking"); 
			set => SetPropertyValue("msdyn_disablewebtracking", value); 
		}

		[AttributeLogicalName("msdyn_disablewebtrackingname")]
		public virtual string MsdynDisablewebtrackingName
		{
			get => GetPropertyValue<string>("msdyn_disablewebtrackingname"); 
		}

		[AttributeLogicalName("msdyn_isminor")]
		public virtual bool? MsdynIsminor
		{
			get => GetPropertyValue<bool?>("msdyn_isminor"); 
			set => SetPropertyValue("msdyn_isminor", value); 
		}

		[AttributeLogicalName("msdyn_isminorname")]
		public virtual string MsdynIsminorName
		{
			get => GetPropertyValue<string>("msdyn_isminorname"); 
		}

		[AttributeLogicalName("msdyn_isminorwithparentalconsent")]
		public virtual bool? MsdynIsminorwithparentalconsent
		{
			get => GetPropertyValue<bool?>("msdyn_isminorwithparentalconsent"); 
			set => SetPropertyValue("msdyn_isminorwithparentalconsent", value); 
		}

		[AttributeLogicalName("msdyn_isminorwithparentalconsentname")]
		public virtual string MsdynIsminorwithparentalconsentName
		{
			get => GetPropertyValue<string>("msdyn_isminorwithparentalconsentname"); 
		}

		[AttributeLogicalName("msdyn_portaltermsagreementdate")]
		public virtual DateTime? MsdynPortaltermsagreementdate
		{
			get => GetPropertyValue<DateTime?>("msdyn_portaltermsagreementdate"); 
			set => SetPropertyValue("msdyn_portaltermsagreementdate", value); 
		}

		[AttributeLogicalName("mspp_userpreferredlcid")]
		public virtual GlobalEnums.ePowerpagelanguages? MsppUserpreferredlcid
		{
			get => (GlobalEnums.ePowerpagelanguages?)GetPropertyValue<OptionSetValue>("mspp_userpreferredlcid")?.Value;
			set => SetPropertyValue("mspp_userpreferredlcid", value is null ? null : new OptionSetValue((int)value)); 
		}

		[AttributeLogicalName("mspp_userpreferredlcidname")]
		public virtual string MsppUserpreferredlcidName
		{
			get => GetPropertyValue<string>("mspp_userpreferredlcidname"); 
		}
		...
		[AttributeLogicalName("sf_accessrole")]
		public virtual eSfAccessRole? SfAccessRole
		{
			get => (eSfAccessRole?)GetPropertyValue<OptionSetValue>("sf_accessrole")?.Value;
			set => SetPropertyValue("sf_accessrole", value is null ? null : new OptionSetValue((int)value)); 
		}

		[AttributeLogicalName("sf_accessrolename")]
		public virtual string SfAccessroleName
		{
			get => GetPropertyValue<string>("sf_accessrolename"); 
		}

		[AttributeLogicalName("sf_ispasswordset")]
		public virtual bool? SfIsPasswordSet
		{
			get => GetPropertyValue<bool?>("sf_ispasswordset"); 
			set => SetPropertyValue("sf_ispasswordset", value); 
		}

		[AttributeLogicalName("sf_ispasswordsetname")]
		public virtual string SfIspasswordsetName
		{
			get => GetPropertyValue<string>("sf_ispasswordsetname"); 
		}

		[AttributeLogicalName("sf_memberairline")]
		public virtual bool? SfMemberAirline
		{
			get => GetPropertyValue<bool?>("sf_memberairline"); 
			set => SetPropertyValue("sf_memberairline", value); 
		}

		[AttributeLogicalName("sf_memberairlinename")]
		public virtual string SfMemberairlineName
		{
			get => GetPropertyValue<string>("sf_memberairlinename"); 
		}

		[AttributeLogicalName("sf_parentairlineid")]
		public virtual EntityReference SfParentAirlineId
		{
			get => GetPropertyValue<EntityReference>("sf_parentairlineid"); 
			set => SetPropertyValue("sf_parentairlineid", value); 
		}

		[AttributeLogicalName("sf_parentairlineidname")]
		public virtual string SfParentAirlineIdName
		{
			get => GetPropertyValue<string>("sf_parentairlineidname"); 
		}
